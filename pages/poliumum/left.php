...
$queryreg = $con->prepare("SELECT * FROM `antrian` WHERE ((`STATUS`='1' OR `STATUS`='11') AND (`TUJUANNO`='4') AND (`TANGGAL`='".$tglsekarang."')) ORDER BY ID ASC LIMIT 1");
$queryreg->execute();
...
$masterpolis = $con->prepare("SELECT * FROM `masterdata` WHERE `STATUS`='1' AND ID_R != '4'");
$masterpolis->execute();
...
<div class="box box-default">
    <div class="box-header with-border">
      ...
      <h3 class="box-title">KLINIK UMUM</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
