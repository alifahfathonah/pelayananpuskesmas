...
$queryreg = $con->prepare("SELECT * FROM `antrian` WHERE ((`STATUS`='1' OR `STATUS`='11') AND (`TUJUANNO`='3') AND (`TANGGAL`='".$tglsekarang."')) ORDER BY ID ASC LIMIT 1");
$queryreg->execute();
...
$masterpolis = $con->prepare("SELECT * FROM `masterdata` WHERE `STATUS`='1' AND ID_R != '3'");
$masterpolis->execute();
...
<audio id="suarabelruangan1" src="../rekaman/polilansia.mp3" ></audio>
<div class="box box-default">
    <div class="box-header with-border">
      <i class="fa fa-user-md"></i>

      <h3 class="box-title">KLINIK LANSIA</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
