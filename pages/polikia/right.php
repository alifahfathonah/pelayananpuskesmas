...
$berikutnya = $con->prepare("SELECT NOMOR, JAM FROM `antrian` WHERE `TUJUANNO`='9' AND STATUS='1' AND TANGGAL='".$tanggal."' ORDER BY ID ASC LIMIT 5");
$berikutnya->execute();
$datab=$berikutnya->fetchAll();

$tunda = $con->prepare("SELECT ID, NOMOR, JAM FROM `antrian` WHERE `TUJUANNO`='9' AND STATUS='0' AND TANGGAL='".$tanggal."' ORDER BY ID ASC LIMIT 5");
$tunda->execute();
