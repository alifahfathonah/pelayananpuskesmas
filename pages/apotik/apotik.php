...
<audio id="suarabelruangan1" src="../rekaman/apotik.mp3" ></audio>
<audio id="suarabelruangan2" src="../rekaman/mengambilobat.mp3" ></audio>
<?php
$tanggal = date("Y-m-d");
//echo $tanggal;
include ('../dbconnect.php');
$berikutnya = $con->prepare("SELECT ID, NOMOR, JAM, TANGGAL, PASIENNM FROM `antrian` WHERE ((STATUS='1' OR STATUS='11') AND (TUJUANNO='11') AND (TANGGAL='".$tanggal."')) ORDER BY ID ASC LIMIT 5");
$berikutnya->execute();
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">ANTRIAN APOTIK</h3>    
  </div>
          ...
          foreach ($datab as $rowtunggu) {
            echo "<tr>";
              ...
              echo "<td>";
                ...
                echo "<a href='#' class='btn bg-orange btn-flat btn-sm selesai' id_antrianT='".$rowtunggu['ID']."'><i class='fa fa-bullhorn'></i> SELESAI</a> ";
              echo "</td>";
            echo "</tr>";
  ...
  <script type="text/javascript">
    $(function() {
        $(".selesai").click(function(){
            ...
            if(confirm("PASIEN TELAH SELESAI BEROBAT.\nKLIK OK UNTUK MELANJUTKAN KE NOMOR LAINNYA")){
                    $.ajax({
                            type: "POST",
                            url: "procselesai.php",
                            data: 'id=' + app_idt,
